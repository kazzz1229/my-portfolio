...
パスワード再発行認証キー入力ページ：https://my-portfolio.fun/freemarket/passRemindRecieve.php
認証キー：{$auth_key}
※認証キーの有効期限は30分となります

認証キーを再発行されたい場合は下記ページより再度再発行をお願い致します。
https://my-portfolio.fun/freemarket/passRemindSend.php

////////////////////////////////////////
カスタマーセンター
E-mail: info@my-portfolio.fun
////////////////////////////////////////
EOT;
